...
function getOAuthStartUrl(shopOrigin, nonce) {
  ...
  return "https://".concat(shopOrigin, "/admin/oauth/authorize?client_id=").concat('34bca23626cd08ecb0533c2a93952058', "&scope=").concat(scopes, "&redirect_uri=").concat(process.env.NEXT_PUBLIC_SHOPIFY_AUTH_CALLBACK_URL, "&state=").concat(nonce);
}