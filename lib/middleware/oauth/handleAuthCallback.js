...
var _default = function _default(handler, options) {
  return /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
      var valid, validateNonce, validNonce, accessTokenQuery, _yield$exchangeAccess, accessToken, redirectPath;
      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 22:
              _yield$exchangeAccess = _context.sent;
              accessToken = _yield$exchangeAccess.data.accessToken;
              _context.next = 26;
